...
function question(a, n) {
    ...
    // 문자열 a에서 특정 문자 n이 나타나는 횟수를 세는 함수를 작성하는 것이 요구
    // 각 문자가 목표 문자 n과 일치하는지 확인하고, 일치하는 경우 result 값을 증가시키는 방식으로 문자열에서 목표 문자의 개수를 세는 로직을 구현
    // for, let을 사용해서 만들어보자 .length활용해보기
